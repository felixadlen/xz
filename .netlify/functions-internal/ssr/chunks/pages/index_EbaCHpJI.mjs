import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, g as renderSlot, f as renderComponent, h as renderHead } from '../astro_9VRvWq-d.mjs';
import 'kleur/colors';
import 'clsx';
import { f as formatDate, $ as $$ContactForm, a as $$Footer, b as $$MenuNav } from './_slug__Izley0FA.mjs';
/* empty css                          */
...
const $$RecentPost = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/stories/did-we-find-inspiration.md": () => import('./did-we-find-inspiration_BHw-gV7f.mjs').then(n => n.d),"../pages/stories/good-things-to-good-people.md": () => import('./good-things-to-good-people_C7KfFlsc.mjs'),"../pages/stories/introducing-xz-studios.md": () => import('./introducing-xz-studios_Xzm1RoZy.mjs')}), () => "../pages/stories/*.md");
