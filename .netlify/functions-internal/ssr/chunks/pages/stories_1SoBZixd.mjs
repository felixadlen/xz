...
import 'kleur/colors';
import 'cssesc';
import { c as $$Container, e as $$BlogPostsList, d as $$Page } from './_slug__1TBfXjIV.mjs';
/* empty css                            */
...
const $$Stories = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Stories;
  const allPosts = (await Astro2.glob(/* #__PURE__ */ Object.assign({"./stories/introducing-xz-studios.md": () => import('./introducing-xz-studios_Qf7BrC2i.mjs')}), () => "./stories/*.{md,mdx}")).sort(
