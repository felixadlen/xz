import { c as createAstro, d as createComponent, r as renderTemplate, f as renderComponent, m as maybeRenderHead, e as addAttribute } from '../astro_9VRvWq-d.mjs';
import 'kleur/colors';
import { c as $$Container, e as $$BlogPostsList, d as $$Page } from './_slug__Izley0FA.mjs';
/* empty css                            */
...
const $$Stories = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Stories;
  const allPosts = (await Astro2.glob(/* #__PURE__ */ Object.assign({"./stories/did-we-find-inspiration.md": () => import('./did-we-find-inspiration_BHw-gV7f.mjs').then(n => n.d),"./stories/good-things-to-good-people.md": () => import('./good-things-to-good-people_C7KfFlsc.mjs'),"./stories/introducing-xz-studios.md": () => import('./introducing-xz-studios_Xzm1RoZy.mjs')}), () => "./stories/*.{md,mdx}")).sort(
