...
i18next.use(fsBackend).init({"supportedLngs": ["en","sv",],"fallbackLng": ["en","sv",],"ns": "translation","defaultNS": "translation","initImmediate": false,"backend": {"loadPath": "./public/locales/{{lng}}/{{ns}}.json",},});fe({"defaultLocale": "en","locales": ["en","sv",],"namespaces": "translation","defaultNamespace": "translation","load": ["server",],"routes": {},"flatRoutes": {},"showDefaultLocale": false,"trailingSlash": "ignore","resourcesBasePath": "/locales","i18nextServer": {"backend": {"loadPath": "./public/locales/{{lng}}/{{ns}}.json",},},});

var __freeze$2 = Object.freeze;
var __defProp$2 = Object.defineProperty;
var __template$2 = (cooked, raw) => __freeze$2(__defProp$2(cooked, "raw", { value: __freeze$2(raw || cooked.slice()) }));
var _a$2;
const $$Astro$c = createAstro("https://xzstudios.se");
...
async function getStaticPaths$1() {
  const allPosts = await Astro$1.glob(/* #__PURE__ */ Object.assign({"../did-we-find-inspiration.md": () => import('./did-we-find-inspiration_3F9Y2Wt_.mjs').then(n => n.d),"../introducing-xz-studios.md": () => import('./introducing-xz-studios_eVL-zZKb.mjs')}), () => "../*.{mdx,md}");
...
const $$file$1 = "/Users/felixadlen/Lokalt/(master) xz-studios/xzstudios.se/src/pages/stories/category/[slug].astro";
const $$url$1 = "/stories/category/[slug]";
...
async function getStaticPaths() {
  const allPosts = await Astro.glob(/* #__PURE__ */ Object.assign({}), () => "../../*.{mdx,md}");
  const sortedPosts = allPosts.sort((a, b) => new Date(b.date).valueOf() - new Date(a.date).valueOf());
  const allCategoriesUnique = /* @__PURE__ */ new Set();
  sortedPosts.forEach((post) => {
    if (post.frontmatter.category) {
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  changeLanguage("sv");
  const { category, posts } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Layout", $$Page, { "data-astro-cid-ltdvj4wd": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Container", $$Container, { "data-astro-cid-ltdvj4wd": true }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="home-hero-text__container" data-astro-cid-ltdvj4wd> <h1 data-astro-cid-ltdvj4wd>${category} Posts</h1> </div> ${renderComponent($$result3, "BlogPostsList", $$BlogPostsList, { "posts": posts, "data-astro-cid-ltdvj4wd": true })} ` })} ` })} `;
}, "/Users/felixadlen/Lokalt/(master) xz-studios/xzstudios.se/src/pages/sv/stories/category/[slug].astro", void 0);

const $$file = "/Users/felixadlen/Lokalt/(master) xz-studios/xzstudios.se/src/pages/sv/stories/category/[slug].astro";
const $$url = "/sv/stories/category/[slug]";
...
export { $$ContactForm as $, P, T, _slug_$1 as _, $$Footer as a, $$MenuNav as b, $$Container as c, $$Page as d, $$BlogPostsList as e, formatDate as f, _slug_ as g };
