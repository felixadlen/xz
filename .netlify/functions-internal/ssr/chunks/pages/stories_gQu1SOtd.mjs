import { c as createAstro, d as createComponent, r as renderTemplate, h as renderComponent, m as maybeRenderHead, e as addAttribute } from '../astro_vTHV1pJ8.mjs';
import 'kleur/colors';
import 'cssesc';
import { $ as $$Container, b as $$BlogPostsList, a as $$Page } from './_slug__cUqK6mSR.mjs';
/* empty css                            */
...
const $$Stories = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Stories;
  const allPosts = (await Astro2.glob(/* #__PURE__ */ Object.assign({"./stories/introducing-xz-studios.md": () => import('./introducing-xz-studios_Wo5Wwlcu.mjs')}), () => "./stories/*.{md,mdx}")).sort(
