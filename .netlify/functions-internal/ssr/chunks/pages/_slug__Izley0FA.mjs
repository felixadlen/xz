import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderComponent, g as renderSlot, h as renderHead, u as unescapeHTML, F as Fragment } from '../astro_9VRvWq-d.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                            */
...
async function getStaticPaths() {
  const allPosts = await Astro.glob(/* #__PURE__ */ Object.assign({"../did-we-find-inspiration.md": () => import('./did-we-find-inspiration_BHw-gV7f.mjs').then(n => n.d),"../good-things-to-good-people.md": () => import('./good-things-to-good-people_C7KfFlsc.mjs'),"../introducing-xz-studios.md": () => import('./introducing-xz-studios_Xzm1RoZy.mjs')}), () => "../*.{mdx,md}");
