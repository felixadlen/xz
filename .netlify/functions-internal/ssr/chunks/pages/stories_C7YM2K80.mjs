import { d as createAstro, c as createComponent, r as renderTemplate, f as renderComponent, m as maybeRenderHead, e as addAttribute } from '../astro_BD0Lb4GF.mjs';
import 'kleur/colors';
import { d as $$Container, g as $$BlogPostsList, e as $$Page } from './_slug__BDqwev0z.mjs';
/* empty css                            */
...
const $$Stories = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Stories;
  const allPosts = (await Astro2.glob(/* #__PURE__ */ Object.assign({"./stories/did-we-find-inspiration.md": () => import('./did-we-find-inspiration_BP3d-cGz.mjs').then(n => n.d),"./stories/good-things-to-good-people.md": () => import('./good-things-to-good-people_DLEnyaaf.mjs'),"./stories/introducing-xz-studios.md": () => import('./introducing-xz-studios_dRovTeRv.mjs')}), () => "./stories/*.{md,mdx}")).sort(
